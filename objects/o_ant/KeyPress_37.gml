...
if (o_controller_player.select_target != noone) && (o_controller_player.select_target.loc_j > 0){
	o_controller_player.select_target.move_direction = 3;
	if o_controller_player.select_target.direction_eff == noone{
		...
		o_controller_player.select_target.direction_eff.image_angle = 0 + 90;
	}
	else{
